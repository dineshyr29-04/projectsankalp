      ...
      <Container>
        <div className="flex flex-col items-center text-center mb-20 relative z-10">
          ...
          >
            ...
            <span className="text-slate-500 font-black uppercase tracking-[0.3em] text-[10px]">
              Strategic Partners
            </span>
          </motion.div>
          ...
          >
            A collective of visionary institutions and organizations committed
            to fostering grassroots innovation.
          </motion.p>
        </div>
          ...
          >
            <div className="space-y-3">
              ...
              <p className="text-sm text-slate-500 font-medium max-w-[200px] mx-auto">
                Showcase your brand to the next generation of innovators.
              </p>
            </div>
