...
export default function Prizes() {
  ...
  return (
    <Section id="prizes" className="relative bg-slate-50/50 py-16 md:py-24 overflow-hidden" ref={containerRef}>
      <motion.div 
        style={{ y: bgY }}
      ...
      <Container className="w-full px-4 sm:px-10 lg:px-20 mx-auto">
        <div className="text-center mb-12 md:mb-16">
          ...
          <h2 className="text-4xl md:text-7xl font-serif font-black mb-6 text-slate-900 tracking-tight leading-tight">
            Recognition & <span className="text-[#2563EB] font-bold italic" >Prizes.</span>
          </h2>
          <p className="text-slate-600 max-w-2xl mx-auto font-medium border-t border-slate-50 pt-6 leading-relaxed text-sm md:text-base">
          ...
          {siteConfig.prizes.map((prize, index) => {
            return (
              <motion.div 
                ...
                className={`group relative p-8 md:p-10 rounded-2xl bg-white border flex flex-col items-center text-center transition-all duration-700 ease-out ${
                  index === 0 
