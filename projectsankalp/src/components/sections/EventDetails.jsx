...
export default function EventDetails() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-0 right-0 w-[800px] h-[800px] rounded-full  mr-400" />
      <div className="absolute bottom-0 left-0 w-[600px] h-[600px] rounded-full  ml-300" />
      ...
      <Container className="w-full px-4 sm:px-10 lg:px-20 mx-auto">
        <div className="flex flex-col gap-20 md:gap-24">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-end">
            ...
            >
              The final phase of Project Sankalp is a high-stakes, 24-hour
              sprint where the most promising social-impact solutions are
              brought to life. Hosted at the state-of-the-art facilities of
              Yenepoya University, the top teams will build the future of social
              entrepreneurship. <br />
              <span className="text-emerald-600 font-black text-[10px] uppercase tracking-[0.1em] mt-8 block bg-emerald-500/5 py-2 px-4 rounded-full border border-emerald-500/10 w-fit">
                Click the venue image below for exact location on Google Maps.
              </span>
            </motion.p>
          </div>
          ...
          <motion.div
            ...
            onClick={() =>
              window.open("https://maps.app.goo.gl/MvM7bL1oeYJvH4Qx7", "_blank")
            }
          >
              ...
              <div className="absolute inset-x-0 bottom-0 p-8 sm:p-10 md:p-16 flex flex-col md:flex-row md:items-end justify-between gap-10">
                <div className="flex flex-col gap-4 md:gap-6">
                  <div className="flex items-center gap-4">
                    ...
                    <span className="text-[10px] md:text-[12px] font-black uppercase tracking-[0.5em] text-[#fffdf5]">
                      Event Venue
                    </span>
                  </div>
                ...
                <div className="flex items-center gap-8 text-white/90 bg-white/5 backdrop-blur-lg px-4 py-6 rounded-2xl border border-white/10 w-fit">
                  <div className="text-center">
                    <span className="text-[9px] md:text-[10px] font-black uppercase tracking-[0.3em] block mb-2 opacity-50">
                      Capacity
                    </span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
            {essentials.map((item, index) => (
              ...
              >
                ...
                <div>
                  <span className="text-[9px] font-black uppercase tracking-[0.3em] text-slate-600 block mb-2">
                    Bring With You
                  </span>
                  <p className="text-m font-bold text-slate-900 tracking-tight">
                    {item.text}
                  </p>
                </div>
              </motion.div>
