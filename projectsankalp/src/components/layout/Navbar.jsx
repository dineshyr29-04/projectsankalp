      ...
      <div className="pointer-events-auto">
        {!isLanding ? (
          <motion.button
            ...
            className="flex items-center gap-3 bg-slate-900 text-white px-6 py-4 rounded-full shadow-2xl hover:bg-slate-800 transition-all active:scale-95 group mb-4"
          >
