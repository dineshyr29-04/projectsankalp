...
export default function RegistrationCheckInPage({
  slots,
  onBack,
  onCheckIn,
  onDelete,
  ...
  const getFilteredTeams = () => {
    let allTeams = [];
    const domainsToShow =
      filterDomain === "all" ? DOMAINS.map((d) => d.id) : [filterDomain];
      ...
      <Container full className="pt-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 md:gap-6 mb-12">
          <div className="bg-gradient-to-br from-blue-500 to-blue-600 text-white p-6 rounded-[32px] shadow-xl shadow-blue-500/20">
            ...
            <p className="text-[10px] font-bold text-blue-100 mt-2">
              {MAX_TEAMS_PER_DOMAIN} per domain
            </p>
          </div>
          ...
          <div className="bg-gradient-to-br from-emerald-500 to-emerald-600 text-white p-6 rounded-[32px] shadow-xl shadow-emerald-500/20">
            ...
            <p className="text-[10px] font-bold text-emerald-100 mt-2">
              Auto Verified
            </p>
          </div>
          ...
          <div className="bg-gradient-to-br from-orange-500 to-orange-600 text-white p-6 rounded-[32px] shadow-xl shadow-orange-500/20">
            ...
            <p className="text-[10px] font-bold text-orange-100 mt-2">
              Awaiting Scan
            </p>
          </div>
          ...
          <div className="bg-gradient-to-br from-slate-700 to-slate-800 text-white p-6 rounded-[32px] shadow-xl">
            ...
            <span className="text-4xl font-black tracking-tighter">
              {stats.totalTeams > 0
                ? Math.round((stats.checkedIn / stats.totalTeams) * 100)
                : 0}
              %
            </span>
              ...
              >
                <div className="flex items-start justify-between mb-4">
                  ...
                  <motion.button
                    ...
                    whileTap={{ scale: 0.9 }}
                    onClick={() =>
                      onDelete && onDelete(team.domain, team.id, team.docId)
                    }
            ...
            <div className="bg-gradient-to-r from-emerald-500 to-emerald-600 text-white p-6 rounded-2xl shadow-2xl flex items-center gap-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-[10px] font-bold opacity-90">
                  {lastScannedTeam.teamId} - {lastScannedTeam.teamName}
                </p>
              </div>
              <button
            ...
            >
              <div className="relative aspect-square">
                ...
                <div className="absolute top-6 left-6 right-6 flex items-center justify-between z-20">
                  ...
                  <button
                    onClick={() => setIsScanning(false)}
                    className="w-10 h-10 rounded-full bg-white/10 backdrop-blur-lg flex items-center justify-center text-white hover:bg-white/20 transition-all"
                  >
                    <X size={18} />
                  </button>
                </div>
