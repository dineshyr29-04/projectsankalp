export const siteConfig = {
  ...
  timeline: [
    {
      ...
      description: "Grand opening and keynote from industry leaders.",
    },
    {
      time: "10:30 AM",
      event: "Team Formation",
      description: "Find your partners and start brainstorming.",
    },
    {
      time: "11:00 AM",
      event: "Hacking Begins",
      description: "Clock starts now! Let the innovation begin.",
    },
    {
      time: "01:00 PM",
      event: "Lunch & Networking",
      description: "Fuel up and meet other participants.",
    },
    {
      time: "04:00 PM",
      event: "Technical Workshop",
      description: "Deep dive into scalable cloud architectures.",
    },
    {
      time: "08:00 PM",
      event: "Mentorship Round 1",
      description: "Get feedback on your prototypes from experts.",
    },
    {
      time: "12:00 AM",
      event: "Midnight Snacks",
      description: "Keep the energy high with some late-night treats.",
    },
    {
      time: "08:00 AM",
      event: "Soft Submission",
      description: "Initial project documentation due.",
    },
    {
      time: "11:00 AM",
      event: "Final Submission",
      description: "Last call for code and video demos.",
    },
    {
      time: "02:00 PM",
      event: "Judging & Demos",
      description: "Present your hard work to our panel of judges.",
    },
    {
      time: "04:00 PM",
  ...
  faq: [
    ...
    },
    {
      ...
      answer:
        "Yes, for in-person participants, we provide all meals and snacks during the offline event.",
    },
    {
      question: "Is there a registration fee?",
      answer:
        "Round 1 is completely free for everyone. Only teams selected for the Offline Grand Finale (Round 2) are required to pay a nominal commitment fee of ₹800 per team, which covers meals, kits, and venue access.",
    },
  ],
};
